...
public class UpdateController {
    ...
    @FXML
    private PasswordField oldPassPasswordField;
    ...
    private void updateBtnHandler(ActionEvent event) {
        ...
        try {
            ...
            if (myObj.isUsernameTaken(userTextField.getText())==false){
                dialogue("enter create user", "User does not exist!");
            ...
            else if (myObj.validateUser(userTextField.getText(), oldPassPasswordField.getText())) {
                myObj.updateUserPasswordTable(userTextField.getText(),  newPassPasswordField.getText());
                dialogue("Adding information to the database", "Successful!");
                String[] credentials = {userTextField.getText(), newPassPasswordField.getText()};
                ...
                Scene scene = new Scene(root, 640, 480);
                secondaryStage.setScene(scene);
                secondaryStage.setTitle("Update User password");
            }
            secondaryStage.show();
            primaryStage.close();
